        ...
        >
          ...
          <router-link :to="{ name: 'mHome' }" class="mTopEl mLogo">
            <div>
              <img
                class="logoImg"
                :src="`https://www.endorphinoutdoor.com/endorphin/wp-content/uploads/2021/02/logo_meta_grigio.png`"
              />
            </div>
          </router-link>
          ...
          <div class="fBody">
            <div class="fbCol">
              <div class="metaFooter">
                <img
                  class="logoImgFooter"
                  :src="`https://www.endorphinoutdoor.com/endorphin/wp-content/uploads/2021/01/Senza-titolo-1-Recuperato-e1611066754719.png`"
                />
              </div>
